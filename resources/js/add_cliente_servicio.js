	...
	******************************************************************************************************/
	asignaValorEdit(dataServicio) {
		...
		// for (let i = 0, celda = 1; i < data2.length; i++) {
			...
			document.getElementsByName("turno1")[0].value = `${dataServicio[i].turno1}`;
			document.getElementsByName("turno2")[0].value = `${dataServicio[i].turno2}`;
			document.getElementsByName('idClientId')[0].value = `${dataServicio[i].id}`;                                                   

			
			/*Seleccionar una opción en el Select2*/
			$("#cuidador_id2").val(`${dataServicio[i].cuidador_id2}`).trigger('change.select2');
			$("#cuidador_id3").val(`${dataServicio[i].cuidador_id3}`).trigger('change.select2');
			$('#clinica_id').val(`${dataServicio[i].clinica_id}`).trigger('change.select2');
	...
	clearElements(){
		...
		$('#cuidador_id2').val(" ").trigger('change.select2');
		$('#cuidador_id3').val(" ").trigger('change.select2');
	...
	activaElement(){
		...
		document.getElementById("tipo_afiliacion_id").disabled = false;
		document.getElementById("rango_eps_id").disabled = false;
		document.getElementById("cubiculos_id").disabled = false;
		...
		document.getElementById("cuidador_id2").disabled = false;
		document.getElementById("cuidador_id3").disabled = false;		
	...
	desactivaElement(){
		...
		document.getElementById("cuidador_id2").disabled = true;
		document.getElementById("cuidador_id3").disabled = true;
		...
		document.getElementById("cama_id").disabled = true;	
