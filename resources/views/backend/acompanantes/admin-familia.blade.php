  ...
  <form role="form" name="formClienteAdmin" id="formClienteAdmin" action="">
    ...
    {{-- <section class="content"> --}}
      <div class="row p-1 m-1">
          ...
          {{-- <div class="col-2"></div>
          <div class="col-4">   
                <a class="btn btn-primary btn-lg" href="{{URL::to('/create-familia')}}" title="Crear / Actualizar y Anular Familiares del Usuarios (clientes)"><i class="fa fa-user-plus"></i><b>Nuevo Usuario</b></a>
          </div>  --}}
       </div>      
    <!-- Main content -->
    <section class="content">
