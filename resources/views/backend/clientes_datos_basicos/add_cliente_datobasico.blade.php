        ...
        <section class="content">
            <div class="card border-2">
                <div class="card-body text-dark tarjeta_body">
                    <form role="form" name="formularioDbasic" id="formularioDbasic">
                        @csrf
                        {{-- @method('post') --}}
                                            ...
                                            <div class="card card-primary card-outline">
                                                <div class="border border-dark border-4 pt-2 rounded bg-primary">
                                                    <h3 id="textB" style="font-weight: 900; font-size: 1.5em;"
                                                        class="card-title">Administracion de Usuarios
                                                    </h3>
                                                </div>
                                                <div class="card-body">
                                                    <!-- <div id="interactive" style="height: 300px;"></div> -->
                                                    <input type="hidden" name="reserva_si_no" id="reserva_si_no"
                                                        value="SI">
                                                    <input type="hidden" name="accionBotones" accion="Guardar"
                                                        id="accionBotones">
                                                    ...
                                                    <div class="row border mt-2 mb-3 border border-primary">
                                                        <div
                                                            class="col-12 col-lg-3 col-md-4 col-sm-2 border border-primary">
                                                        ...
                                                        <div
                                                            class="col-12 col-lg-3 col-md-4 col-sm-2 border border-primary pb-2">
                                                            <label for="" class="">*Doc Identidad</label>
                                                            <input type="text" class="form-control text focusNext pb-2"
                                                                maxlength="25" tabindex="2" name="num_documento"
                                                                id="num_documento" pattern="[A-Za-z0-9]{1,25}"
                                                                placeholder="Digite No. del documento" style="height:40px;">
                                                        </div>
                                                        <div
                                                            class="ccol-12 col-lg-3 col-md-4 col-sm-2 border border-primary">
                                                            <label for="nombre" class="">*Nombre:</label>
                                                            <input type="text" class="form-control text focusNext"
                                                                maxlength="40" tabindex="3" name="nombre" id="nombre"
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control text focusNext"
                                                                maxlength="40" tabindex="4" name="apellidos"
                                                                id="apellidos" placeholder="digite apellidos">
                                                        </div>
                                                    </div> <!--cierra row-->
                                                    ...
                                                    <div class="row border mt-2 mb-3 border border-primary">
                                                        <div
                                                            class="col-12 col-lg-1 col-md-4 col-sm-2 border border-primary pb-2">
                                                            <label for="edad" class="">Edad:</label>
                                                            <input type="text" class="form-control text focusNext"
                                                                name="edad" tabindex="9" id="edad"
                                                                placeholder="Edad">
                                                        </div>
                                                        <div
                                                            class="col-12 col-lg-2 col-md-4 col-sm-2 border border-primary pb-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="col-12 col-lg-4 col-md-4 col-sm-2 border border-primary pb-2">
                                                                ...
                                                                <select class="form-control focusNext text" style="width: 100%;" 
                                                    ...
                                                    <div class="row border mt-2 mb-3 border border-primary ">
                                                        <div
                                                            class="col-12 col-lg-5 col-md-4 col-sm-2 border border-primary pb-2">
                                                            <label for="dirRes" class="">Dirección
                                                                Residencial:</label>
                                                            <input type="text" class="form-control text focusNext"
                                                                maxlength="100" name="direccion_res" tabindex="14"
                                                                id="direccion_res"
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="text" class="form-control text focusNext"
                                                                maxlength="50" name="barrio_res" tabindex="14"
                                                                id="barrio_res"
                                                                placeholder="Barrio residencial">
                                                        </div>
                                                        <div
                                                            class="col-12 col-lg-4 col-md-4 col-sm-2 border border-primary pb-2">
                                                            <label for="" class="">*Email Usuario:</label>
                                                            <input type="email" class="form-control text focusNext"
                                                                maxlength="50" tabindex="14" id="email_user"
                                                                name="email_user" placeholder="Digite Email existente">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.card-body-->
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <input type="text" 
                                                            ...
                                                            id="peso" tabindex="15" name="peso" pattern="[A-Za-z0-9]{1,25}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>                                        
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <div class="form-group">
                                                            <label for="" class="">Estado de usuario
                                                            </label>
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input" type="radio"
                                                                    id="customRadio1" name="estado_user" checked
                                                                    tabindex="17" >
                                                                <label for="customRadio1"
                                                                    class="custom-control-label">Activo</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input" type="radio"
                                                                    id="customRadio2" name="estado_user" tabindex="18"
                                                                    >
                                                                <label for="customRadio2"
                                                                    class="custom-control-label">Inactivo</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input class="custom-control-input" type="radio"
                                                                    id="customRadio3" name="estado_user" tabindex="19"
                                                                    >
                                                                <label for="customRadio3"
                                                                    class="custom-control-label">Fallecido</label>
                                                            </div>
                                                        </div>
                                                        <!-- </div> -->
                                                    </div>
...
<script>
    ...
    window.addEventListener('load', () => {
        ...
        ***********************************************************************************************/
        ...
        const frm_Dbasic = document.querySelector('#formularioDbasic');
        // let frm_Dbasic = document.getElementById('formularioDbasic')
        frm_Dbasic.addEventListener('submit', (e) => {
            e.preventDefault();
            // var focoElement = "";
            let validaOk = "OK";
            ...
            if (validaOk === "") { // si no hay campos vacíos
                let data = new FormData(frm_Dbasic);
                ...
                if (attrAccion2 == 'Guardar') {
                    ...
                    const clienteNew = async () => {
                        await axios.post(
                            ...
                            let texto2 = document.getElementById('textB')
                            texto2.innerHTML =
                                'ESPERANDO POR UN NUEVO REGISTRO DE USUARIO'
                            document.getElementById('btnDelete').disabled = true;
                            document.getElementById('btnEdit').disabled = true;
                            document.getElementById('btnNew').disabled = false;
                            document.getElementById('btnSearch').disabled = false;
                        ...
                        await axios.post("{{ URL::to('/anulaRegistroBsc') }}", data, {
                            ...
                            if (response.data['message'] == "Success") {
                                ...
                                document.getElementById('textB').innerHTML =
                                    'ANULACION DE REGISTRO DE USUARIOS'
