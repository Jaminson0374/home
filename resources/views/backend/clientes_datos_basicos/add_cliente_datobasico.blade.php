                                        ...
                                        <div class="card-body c-body">
                                            ...
                                            <div class="row border mt-2 mb-3 border border-primary">
                                                <div class="col-12 col-lg-12 col-md-4 col-sm-2 border border-primary pb-2">
                                                    ...
                                                    <textarea type="text" class="form-control text" id="suministro_medic" name="suministro_medic"
                                            ...
                                            <div class="row border mt-2 mb-3 border border-primary">
                                                <div class="col-12 col-lg-12 col-md-4 col-sm-2 border border-primary pb-2">
                                                    ...
                                                    <textarea type="text" class="form-control text" id="observacion" name="observacion"
