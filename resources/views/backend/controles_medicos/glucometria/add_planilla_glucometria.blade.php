                            ...
                            <body>
                                ...
                                <div class="row border border-dark border-4 m-2 rounded bg-primary">
                                    <div class="col-12 col-sm-12 col-lg-6 col-md-6">
                                        <h3 id="textB" style="font-weight: 900; font-size: 1.5em;" class="card-title">Control de grlucometría
                                        </h3>
                                    </div>
                                    <div class="col-12 col-sm-12 col-lg-6 col-md-6">
                                            ...
                                            <div class="card card-primary card-outline">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 col-sm-12 col-md-2"> 
                                                        ...
                                                        <input type="number" placeholder="mg/dl" class="form-control text focusNext p-0"  id="glucometria"  name="glucometria" tabindex="5">
                                                    </div>                                                    
                                                    
                                                    <div class="col-12 col-lg-4 col-md-4 col-sm-12 border border-primary pb-2">
                                                        <label class="">Cuidador de turno</label>
                                ...
                                <script src="{{ asset('../resources/views/backend/controles_medicos/glucometria/glucometria.js') }}"></script>
