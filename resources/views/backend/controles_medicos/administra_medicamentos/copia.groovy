 //formulario: ADMINISTRAR_MEDICAMENTO_PERMANENTES
 //versión: 1
 //estado: ok
 //Detalle: en esta versión se llelan 2 tablas una que viedrectamente de dbf asigna_medicamentos
                            ...
                            <body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-12 col-md-7 ">  
                                            ...
                                            <div class="card card-warning card-outline">
                                                {{-- <div class="card-body"> --}}
                                                    <div class="col-lg-12 col-sm-12 col-md-12 bg-primary"> 
                                                        <label class="bg bg-warning" for="">MEDICAMENTOS ESTABLECIDOS COMO PERMANENTES</label>  
                                                        <table id="tablaAsigMedic" class="table table-bordered table-striped table-hover" style="width:100%">
                                        ...
                                        <div class="col-lg-5 col-sm-12 col-md-5 p-0 m-0">
                                            {{-- <div class="col-lg-12 col-sm-12 col-md-12"> --}}
                                                <div class="card card-warning card-outline">
                                                    {{-- <div class="card-body"> --}}
                                                        <div class="col-lg-12 col-sm-12 col-md-12 bg-success"> 
                                                            <label class="bg bg-primary" for="">MEDICAMENTOS QUE SE ADMINISTRARON EN LA FECHA</label> 
                                                            <table id="tablaAsignados" class="table table-bordered table-striped table-hover table-responsive" style="width:100%">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Medicamento</th>
                                                                        <th>Hora</th>
...
//formulario: ADMINISTRAR_MEDICAMENTO_PERMANENTES
 //versión: 2  reducida a una sola tabla
 //estado: ok
 //Detalle: en esta versión se llelan una sola tabla una que viedrectamente de dbf admin_medicamentos_permanentes
 @extends('backend.layouts.app')
@section('content')
<style>
    .tarjeta_body {
